...
public class ImageResize extends ImageWorker {
     ...
     */
    public ImageResize(Context context, int imageWidth, int imageHeight) {
        super(context);
     ...
     * Initialize providing a single target image size (used for both width and height);
     */
    public ImageResize(Context context, int imageSize) {
        super(context);
    ...
    protected Bitmap processBitmap(Object data_main, Object data_secondary) {
        return processBitmap(Integer.parseInt(String.valueOf(data_main)),
                Integer.parseInt(String.valueOf(data_secondary)));
    }
