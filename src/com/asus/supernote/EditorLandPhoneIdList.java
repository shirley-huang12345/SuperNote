...
public class EditorLandPhoneIdList extends EditorIdList {
	public EditorLandPhoneIdList() {
    ...
    public int[] editorActionBarDoodle = {
            R.id.note_kb_d_done
    };

    public int[] editorActionBarSelText = {
            R.id.note_kb_done
    };

    public int[] editorActionBarTextimg = {
            R.id.note_kb_textimg_cancle,
            R.id.note_kb_textimg_done
    };
    public int[] editorActionBarPickColor = { //smilefish
            R.id.note_kb_color_cancel,
            R.id.note_kb_color_done
    };
