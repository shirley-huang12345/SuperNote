...
public class PaintSelector {
    ...
    private static final int SKETCH_ALPHA = 80;
    private static final int NORMAL_ALPHA = 60;
    private static final float NORMAL_BLUR = 6f;
    private static final float SCRIBBLE_BLUR = 1f;
    private static final float SKETCH_BLUR = 1f;
  ...
  //end wendy
    ...
    public static void setNeon(Paint paint) {
        reset(paint);
    }
    ...
    public static void setScribble(Paint paint) {
        reset(paint);
        BlurMaskFilter blur = new BlurMaskFilter(SCRIBBLE_BLUR, BlurMaskFilter.Blur.NORMAL);
        paint.setMaskFilter(blur);
    }

    public static void setSketch(Paint paint) {
        reset(paint);
        BlurMaskFilter blur = new BlurMaskFilter(SKETCH_BLUR, BlurMaskFilter.Blur.NORMAL);
        paint.setMaskFilter(blur);
        paint.setAlpha(SKETCH_ALPHA);
    }
    //begin wendy
    public static void setMarkPen(Paint paint)
    {
    	reset(paint);
    	paint.setStrokeCap(Paint.Cap.SQUARE);
    }
    public static void setWritingBrush(Paint paint)
    {
    	reset(paint);
    }
    //end wendy
